...
(defmethod staticl/format:to-html ((text string) (format (eql :spinneret)) (content-file pathname) (relative-to-content-file pathname) &key absolute-urls content-url)
